      ...
      <Card className="w-full max-w-6xl mx-auto">
        ...
        <CardContent>
          <div className="aspect-video w-full rounded-lg overflow-hidden border">
            <iframe
              src="https://theseo.vercel.app/id/youtube-optimization"
              title="The SEO Demo"
          ...
          <div className="mt-4 text-center text-sm text-muted-foreground">
            <p>
              ...
              <Link href="https://theseo.vercel.app/id/youtube-optimization" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary">
                kunjungi situs live
              </Link>.
            </p>
          </div>
